					...
					if (get_post_type()=='articulos') { 
			            ...
			            <div style="display:none">
			                <div id="<?php echo $postid; ?>">
			                  ...
			                  <h5 class="letranegra"><?php echo $grupo; ?></h5>
			                  <h5 class="letranegra"><?php echo $codigo; ?></h5>
			                  <h5 class="letranegra"><?php echo nombre; ?></h5>
			                  <h5 class="letranegra">Aplicación: <?php echo $aplicacion; ?></h5>
			                  <h5 class="letranegra">Existencia: <?php echo $existencia; ?></h5>
			                  <h5 class="letranegra">Datos: <?php echo $datos; ?></h5>
			                  <h5 class="letranegra">Especificación: <?php echo $especificacion; ?></h5>
			                </div>
			            </div>
					<?php }
